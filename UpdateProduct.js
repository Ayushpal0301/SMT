                ...
                <div className="card">
                 <h1 className='text-center pt-2'>Update Product</h1> 
                    <div className="m-1 w-75 ps-3">
                      ...
                      <div className="mb-3">
                        <textarea type="text" rows='3'  value={description}  placeholder='Enter product description' className='form-control' onChange={(e)=>setDescription(e.target.value)} />
                      </div>
                      <div className="mb-3">
                        <input type="text" value={price} placeholder='Enter product price' className='form-control' onChange={(e)=>setPrice(e.target.value)} />
                      </div>
                      <div className="mb-3">
